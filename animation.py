...
nodesTotal = 7  # число узлов
nodesDelay = 80  # время появления нового узла
curDelay = 0
elMinSize = 5  # размер итогового кружка
elMaxSize = 30

stripesMin = 3  # минимальное число полос от узла
stripesMax = 80  # максимальное число полос от узла
stripesLength = 50  # средняя длина полосы
stripesLengthD = 30  # разброс длин полосы

exponent = 20  # кривизна линий
...
class Node():
    def __init__(self, ):
        ...
        self.step = randint(1, 3)  # - величина шага на пути линии
        self.last_size = randint(elMinSize, elMaxSize)
        self.lasting = randint(int(nodesDelay / 4), nodesDelay)  # - время застывания итоговых фигур
